...
export function PlaceCard({ place, icon: Icon, route }: PlaceCardProps) {
  return (
    <li className="flex gap-3 rounded-xl bg-stone-50 p-3.5 ring-1 ring-stone-200">
      ...
      <div className="min-w-0 flex-1">
        ...
        <a
          href={buildMapsDirectionsUrl(
            route.origin,
            `${place.name}, ${route.destinationContext}`,
          )}
          target="_blank"
          rel="noopener noreferrer"
          className="mt-2 inline-flex items-center gap-1.5 text-xs font-semibold text-brand-700 underline-offset-2 hover:underline"
        >
